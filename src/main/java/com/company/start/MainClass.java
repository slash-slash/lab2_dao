...
public class MainClass {
    ...
    public static void main(String[] args) {
        String DbOperation = "EXIT(0), ADDSTUDENT(1), UPDATESTUDENT(2), DELETESTUDENT(3), FETCHSTUDENTBYID(4), FETCHBYEMAIL(5), FETCHBYMOBNO(6), FETCHBYNAME(7),"
                + "FETCHBYCITY(8), FETCHBYSALRANGE(9), FETCHBYDOB(10), FETCHBYDOJRANGE(11), FETCHALLSTUDENTS(12), ADDSUBJECT(13), DELETESUBJECT(14), FETCHALLSUBJECTS(15)";
    ...
    public void addSubject() {
        ...
        subject.setCapacity(insert.nextInt());
        subjectAction.insert(subject);
    }
